...
public class ApplicationUserConfiguration : IEntityTypeConfiguration<ApplicationUser>
{
	...
	public void Configure(EntityTypeBuilder<ApplicationUser> builder)
	{
		...
		admin.PasswordHash = HashUserPassword(admin, "Admin@123SmartDelala");

		builder.HasData(admin);
		
		//More Users with PropertyBuyer and PropertySeller Role
		builder.HasData(
				new ApplicationUser
				{
					Id = "2e4c2829-138d-4e7e-b023-123456789001",
					UserName = "PropertyBuyer1",
					NormalizedUserName = "PropertyBuyer1".ToUpperInvariant(),
					Email = "PropertyBuyer1@gmail.com",
					NormalizedEmail = "PropertyBuyer1@gmail.com".ToUpperInvariant(),
				...
				new ApplicationUser
				{
					...
					UserName = "PropertyBuyer2",
					NormalizedUserName = "PropertyBuyer2".ToUpperInvariant(),
					Email = "PropertyBuyer2@gmail.com",
					NormalizedEmail = "PropertyBuyer2@gmail.com".ToUpperInvariant(),
				...
				new ApplicationUser
				{
					...
					UserName = "PropertyBuyer3",
					NormalizedUserName = "PropertyBuyer3".ToUpperInvariant(),
					Email = "PropertyBuyer3@gmail.com",
					NormalizedEmail = "PropertyBuyer3@gmail.com".ToUpperInvariant(),
				...
				new ApplicationUser
				{
					...
					UserName = "PropertyBuyer4",
					NormalizedUserName = "PropertyBuyer4".ToUpperInvariant(),
					Email = "PropertyBuyer4@gmail.com",
					NormalizedEmail = "PropertyBuyer4@gmail.com".ToUpperInvariant(),
				...
				new ApplicationUser
				{
					...
					UserName = "PropertyBuyer4",
					NormalizedUserName = "PropertyBuyer5".ToUpperInvariant(),
					Email = "PropertyBuyer5@gmail.com",
					NormalizedEmail = "PropertyBuyer5@gmail.com".ToUpperInvariant(),
					FullName = "Amha Kindu",
				...
				// Add more PropertyBuyer users here...
			);
			...
			builder.HasData(
				new ApplicationUser
				{
					...
					UserName = "PropertySeller1",
					NormalizedUserName = "PropertySeller1".ToUpperInvariant(),
					Email = "PropertySeller1@gmail.com",
					NormalizedEmail = "PropertySeller1@gmail.com".ToUpperInvariant(),
				...
				new ApplicationUser
				{
					...
					UserName = "PropertySeller2",
					NormalizedUserName = "PropertySeller2".ToUpperInvariant(),
					Email = "PropertySeller2@gmail.com",
					NormalizedEmail = "PropertySeller2@gmail.com".ToUpperInvariant(),
					FullName = "Kalu Siyum",
				...
				new ApplicationUser
				{
					...
					UserName = "PropertySeller3",
					NormalizedUserName = "PropertySeller3".ToUpperInvariant(),
					Email = "PropertySeller3@gmail.com",
					NormalizedEmail = "PropertySeller3@gmail.com".ToUpperInvariant(),
					FullName = "Aster Nesu",
				...
				new ApplicationUser
				{
					...
					UserName = "PropertySeller4",
					NormalizedUserName = "PropertySeller4".ToUpperInvariant(),
					Email = "PropertySeller4@gmail.com",
					NormalizedEmail = "PropertySeller4@gmail.com".ToUpperInvariant(),
				...
				new ApplicationUser
				{
					...
					UserName = "PropertySeller4",
					NormalizedUserName = "PropertySeller5".ToUpperInvariant(),
					Email = "PropertySeller5@gmail.com",
					NormalizedEmail = "PropertySeller5@gmail.com".ToUpperInvariant(),
				...
				// Add more PropertySeller users here...
			);
